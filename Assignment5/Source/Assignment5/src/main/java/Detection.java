...
/**
 * Created by latha on 9/28/2016.
 */
public class Detection {
    public static void main(String args[]) throws IOException {
        ObjectDetection objectMainDetection = new ObjectDetection();
    }
}
...
//    private RenderMode renderMode = RenderMode.SQUARE;
    ...
    public void StartVideo() throws IOException {
        Video<MBFImage> video = new XuggleVideo(new File("data/BackStroke.mkv"));
            ...
            if (this.matcher1.findMatches(kpl)
                ...
                try {
                    ...
                    if (modelImage1.getBounds().transform(boundsToPoly).isConvex()) {
                        ...
                        renderer.drawText("Person Swimming",(1*30)+30, (1*30)+60, HersheyFont.ASTROLOGY, 30, RGBColour.RED);
