/**
 * Created by santu_pc on 10/19/2016.
 */
import Jama.Matrix;
...
//    private RenderMode renderMode = RenderMode.SQUARE;
    ...
    public static void main(String args[]) throws IOException {
        String VideoFilePath = "data/BackStroke.mkv";
            ...
            if (this.matcher1.findMatches(kpl)
                ...
                try {
                    ...
                    if (modelImage1.getBounds().transform(boundsToPoly).isConvex()) {
                        ...
                        renderer.drawText("Back STroke",(1*30)+30, (1*30)+60, HersheyFont.ASTROLOGY, 30, RGBColour.RED);
