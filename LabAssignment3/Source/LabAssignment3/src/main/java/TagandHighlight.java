...
//        VideoDisplay<MBFImage> display = VideoDisplay.createVideoDisplay(video);
    ...
    public static void getTags() throws IOException, InterruptedException{
        ...
        String APP_ID = "G6inGmifzq1nlE0iHyg0ITSPTpzhlHHHz5jTKJ5j";
        String APP_SECRET = "_0Cu-67PwlEYY_yBrlNEYmucc5k-m1R7GWZNRLN5";
        ClarifaiClient clarifai = new ClarifaiClient(APP_ID, APP_SECRET);

        File Fpath = new File("output/mainframes");
        ...
        for(int i=0;i<results.size();i++){
            ...
            for (Tag tag : results.get(i).getTags()) {
                ...
                image.drawText(tag.getName(), (j*30)+30, (j*30)+60, HersheyFont.ASTROLOGY, 30, RGBColour.RED);
                if(++j>6){
                    break;
                }
                //break;
            ...
            for(int k=1;k<200;k++) {
                DisplayUtilities.displayName(image, "TagandHighlight");
            }
        }
